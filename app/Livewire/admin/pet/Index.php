...
class Index extends Component
{
    ...
    {
        $caretOrder = $this->sortOrder == 'asc' ? 'down' : 'up';
    ...
    public function switch()
    {
        ...
        $this->switchLabel = $this->switch ? 'Grid' : 'Table';
    }
    ...
    public function delete($id)
    {
        ...
        $folder = public_path('pet-images/'.$pet->images_folder);

        File::deleteDirectory($folder);

        $pet->delete();

        $this->dispatch('update-pets');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.pet.index', ['pets' => $pets]);
    }
