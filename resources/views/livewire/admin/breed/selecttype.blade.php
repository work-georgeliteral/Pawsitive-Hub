<div class="p-5" style="margin-top: 40px;">
    ...
    <div class="col-md-4">
        ...
        <div class="card text-center shadow-sm">
            <div class="card-body">
                <h1 class="display-4">
                    <a href="/breeds/create/dog" class="text-decoration-none" style="color: black;"><i class="fas fa-dog"> Dog</i></a>
                </h1>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        ...
        <div class="card text-center shadow-sm">
            <div class="card-body">
                <h1 class="display-4">
                    <a href="/breeds/create/cat" class="text-decoration-none" style="color: black;"> <i class="fas fa-cat">                    Cat</i></a>
                </h1>
            </div>
        </div>
    </div>
